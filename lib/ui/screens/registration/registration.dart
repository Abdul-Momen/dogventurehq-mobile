...
class _RegistrationPageState extends State<RegistrationPage> {
          ...
          if (_key.currentState!.validate()) {
            Get.dialog(
              PaymentDialog(
                ...
                totalPrice: totalPrice * petNameList.length,
                fromPage: 'Vet-Clinic',
                orderPlaceFn: () => _placeVetConsultation(),
              ),
            );
          }
        };
          ...
          if (_key.currentState!.validate()) {
            Get.dialog(
              PaymentDialog(
                screenNumValue: screenNumValue,
                totalPrice: totalPrice * petNameList.length,
                fromPage: 'training-academy',
                orderPlaceFn: () => _placeTraining(),
              ),
            );
          }
        };
        ...
        return () {
          if (_key.currentState!.validate()) {
            Get.dialog(PaymentDialog(
              ...
              totalPrice: totalPrice * petNameList.length,
              fromPage: 'Event',
              orderPlaceFn: () => _placeEventBooking(),
            ));
          }
        };
  ...
  _launchWhatsapp() async {
    ...
    const url =
        "https://dogventurehq.com/admin//Content/ActivityWavier/event/DHQEvent.pdf";
  ...
  void _placeEventBooking() async {
    ...
    invoiceList.add(
      InvoiceRequestModel(
        invoiceId: 0,
        totalAmount: _eventController.totalPrice.value,
        receivedAmt: 0,
        paymentMethod: 1,
        carryingCost: 0,
        courierCharge: 0,
        storeId: _eventController.eventDetails!.storeId,
        supplierId: _eventController.eventDetails!.supplierId,
        invoiceStatusId: 0,
        isService: true,
        ...
        invoiceDetailsRequestModels: [
          InvoiceDetailsRequestModel(
            invoiceDetailsId: 0,
            invoiceId: 0,
            productMasterId: _eventController.eventDetails!
                .eventTicketsProductMasterViewModels![0].productMasterId,
            quantity: 1,
            price: _eventController.eventDetails!
                .eventTicketsProductMasterViewModels![0].productPrice,
            productSubSkuId: 0,
          ),
          ...
          /* InvoiceDetailsRequestModel(
            ...
            invoiceId: 0,
            productMasterId: _eventController.eventDetails!
                .eventTicketsProductMasterViewModels![1].productMasterId,
            quantity: 1,
            price: _eventController.eventDetails!
                .eventTicketsProductMasterViewModels![1].productPrice,
            productSubSkuId: 0,
          ),*/
        ],
          ...
          if (_eventController.eventBookingLoadingFlag.value) {
            if (_registrationController.registrationLoadingFlag.isFalse) {
                  ...
                  InvoiceRequestModel(
                    ...
                    invoiceDetailsRequestModels: [
                      ...
                      InvoiceDetailsRequestModel(
                        ...
                        productMasterId: _eventController
                            .eventDetails!
                            .eventTicketsProductMasterViewModels![1]
                            .productMasterId,
                        quantity: 1,
                        price: _eventController
                            .eventDetails!
              ...
              OrderModel orderModel = OrderModel(
                ...
                carryingCost: 0,
                invoiceStatusId: 0,
                eventId: _eventController.eventDetails!.eventId,
                ...
                paymentRequestModels: [
                  PaymentRequestModel(
                    paymentId: 0,
                    currencyId: 1,
                    amount: _eventController.totalPrice.value,
                    courierCharge: 0,
                    carryingCost: 0,
                    paymentMethod: 1,
                  ),
              ...
              print('calling event booking method:');
  ...
  void _placeVetConsultation() async {
    regModels.clear();
    for (int i = 0; i < numOfTicket; i++) {
      // print(
      //     nameTextController[i].text,
    ...
    invoiceList.add(
      InvoiceRequestModel(
        invoiceId: 0,
        totalAmount: _vetClinicController.consultationDetails!.productDecimal,
        receivedAmt: 0,
        paymentMethod: 1,
        carryingCost: 0,
        courierCharge: 0,
        storeId: _vetClinicController.consultationDetails!.storeId,
        supplierId: _vetClinicController
            .consultationDetails!.supplierRequestModel.supplierId,
        invoiceStatusId: 0,
        isService: true,
        ticketBuyForCustomerId: 0,
        checkIn: DateTime.now(),
        ...
        invoiceDetailsRequestModels: [
          InvoiceDetailsRequestModel(
            invoiceDetailsId: 0,
            invoiceId: 0,
            productMasterId: _vetClinicController.consultationDetails!
                .productDetailsRequestModel.productMasterId,
            quantity: 1,
            price: _vetClinicController.consultationDetails!.productDecimal,
            productSubSkuId: 0,
          )
        ],
        invoiceDetailsViewModels: [],
          ...
          if (_eventController.eventBookingLoadingFlag.value) {
            if (_registrationController.registrationLoadingFlag.isFalse) {
              ...
              OrderModel orderModel = OrderModel(
                ...
                customerId: Preference.getUserId(),
                totalAmount:
                    _vetClinicController.consultationDetails!.productDecimal,
                receivedAmt: 0,
                courierCharge: 0,
                carryingCost: 0,
                invoiceStatusId: 0,
