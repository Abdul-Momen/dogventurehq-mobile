...
class PhotoUploadMedicalBtn extends StatefulWidget {

  final void Function(File) setMedicalPhotoFn;

  const PhotoUploadMedicalBtn({Key? key, required this.setMedicalPhotoFn}) : super(key: key);

  @override
  State<PhotoUploadMedicalBtn> createState() => _PhotoUploadBtnState();
}

class _PhotoUploadBtnState extends State<PhotoUploadMedicalBtn> {
